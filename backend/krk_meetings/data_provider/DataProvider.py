...
class DataProvider:
    ...
    def start(self):
        ...
        self.alive = True
        LOG.info("DataProvider: has started.")
        while self.alive:
            try:
                ...
                LOG.warn("DataProvider: internet connection lost")
            time.sleep(3600)
    ...
    def process_data(self):
        LOG.info("DataProvider: updating data")
        ...
        LOG.info("DataProvider: data extracted")

        extracted_data.save(self.data_path)
        LOG.info("DataProvider: data saved")
