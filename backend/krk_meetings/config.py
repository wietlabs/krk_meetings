...
from krk_meetings.data_provider.ExtractorConfiguration import ExtractorConfiguration
...
DEFAULT_EXTRACTOR_CONFIGURATION = ExtractorConfiguration(
    ...
    change_penalty=1800,
    nightly_route_ranges=[(60, 69), (600, 699), (900, 999)],
...
class ErrorCodes(Enum):
    ...
    INTERNAL_DATA_NOT_LOADED = {"error": "INTERNAL SERVER ERROR DATA NOT LOADED"}
