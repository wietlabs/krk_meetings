...
connection1 = ConnectionResults([
    Transfer('139', 'Czarnowiejska', 'Miasteczko Studenckie AGH', datetime(2019, 1, 1, 12, 34), datetime(2019, 1, 1, 12,37)),
])

connection2 = ConnectionResults([
    Transfer('611', 'Czarnowiejska', 'Miasteczko Studenckie AGH', datetime(2019, 12, 31, 23, 59), datetime(2020, 1, 1, 0, 1)),
])

connection3 = ConnectionResults([
    Transfer('139', 'Czarnowiejska', 'Plac Inwalidów', datetime(2020, 6, 13, 13, 3), datetime(2020, 6, 13, 13, 6)),
    Transfer('179', 'Plac Inwalidów', 'Jubilat', datetime(2020, 6, 13, 13, 7), datetime(2020, 6, 13, 13, 12)),
    Transfer('252', 'Jubilat', 'Kraków Airport', datetime(2020, 6, 13, 13, 14), datetime(2020, 6, 13, 13, 40)),
])
