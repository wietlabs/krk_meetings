...
openrouteservice_api_key = '5b3ce3597851110001cf624843029e8877264fc2be5416051d04d801'  # Specify your personal API key
...
def reparse_walking_distances():
    ...
    api_stop_list = set(walking_distances_pickle['stop_list'])
    ...
    for name_1, lon_1, lat_1, name_2, lon_2, lat_2 in adjacent_stops:
        ...
        if (name_1, name_2) in api_walking_distances.keys():
            continue
        api_stop_list.add(name_1)
        api_stop_list.add(name_2)
        time.sleep(2)
